                  ...
                  <div className="form-inline items-start flex-col xl:flex-row mt-10">
                    <div className="form-label w-full xl:w-64 xl:!mr-10">
                      <div className="text-left">
                        <div className="flex items-center">
                          <div className="font-medium">Hình ảnh môn học</div>
                    ...
                    <div className="w-full mt-3 xl:mt-0 flex-1 border-2 border-dashed dark:border-darkmode-400 rounded-md pt-4">
                      ...
                      <div className="px-4 pb-4 mt-5 flex items-center justify-center cursor-pointer relative">
                        ...
                        <span className="text-primary mr-1">Tải tài liệu</span>
                        tải hình ảnh lên
                        <input
                ...
                <div className="mt-5">
                  <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                    <div className="form-label xl:w-64 xl:!mr-10">
                      <div className="text-left">
                        <div className="flex items-center">
                          <div className="font-medium">Tên môn học</div>
                          <div className="ml-2 px-2 py-0.5 bg-slate-200 text-slate-600 dark:bg-darkmode-300 dark:text-slate-400 text-xs rounded-md">
                            Bắt buộc
                          </div>
                        </div>
                  ...
                  <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                    ...
                    <div className="w-full mt-3 xl:mt-0 flex-1">
                      <select id="category" className="form-select">
                        <option value="Hobby">Tử tưởng HCM</option>
                        <option value="Kids & Baby">Lịch sử đảng cộng sản VN</option>
                        <option value="Kids & Baby">Nhập môn CNTT</option>
                        <option value="Photography">Lập trình web</option>
                        <option value="Hobby">Chính trị mác lênin</option>
                        <option value="PC & Laptop">Pháp luật đại cương</option>
                        <option value="Home Appliance">Triết học mác lê nin</option>
                        <option value="Photography">pháp luật dân sự</option>
                        <option value="Electronic">Nhập môn java</option>
                      </select>
                    </div>
                  </div>
                  <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
