        ...
        <div className="mt-24 flex">
          <div className="w-1/4  rounded-lg border-3 border-[#E9C37C] p-4  ">
            ...
            <div className="px-4">
              <div className="">
                ...
                <div className="flex justify-between mt-2	">
                  <div className="w-10 h-10 bg-gray-300 rounded-full flex items-center justify-center">
                    <button className="text-gray-600 font-bold text-lg focus:outline-none">
                      1
                    </button>
                  </div>
                  <div className="w-10 h-10 bg-gray-300 rounded-full flex items-center justify-center">
              ...
              <div className="mt-52">
                ...
                <button
                  type="button"
                  className="mt-3 w-full text-white bg-red-700 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"
                >
                  Nộp bài
                </button>
              </div>
          ...
          <div className="w-3/4 bg-white ml-7	">
            <div className="w-4/5 m-auto ">
              ...
              <div>
                <button className="text-left w-full bg-[#F5EADA] mt-4  font-bold py-2 px-4 border border-blue-700 rounded-3xl		">
                  A. Tô Hoài
                </button>
                <button className="text-left w-full bg-[#F5EADA] mt-4  font-bold py-2 px-4 border border-blue-700 rounded-3xl		">
                  B. Nguyễn Tuân
