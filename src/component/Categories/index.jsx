...
export default function Categories() {
  return (
    <div className="intro-y box p-5 mt-6">
      <div className="mt-1">
        <Link to="/product-list" className=" flex items-center px-3 py-2 mt-2 rounded-md transition duration-300 ease-in-out transform hover:scale-110 hover:bg-blue-600 text-slate-950	 font-bold">
